...
export default function AnimeCard({ anime }: AnimeCardProps) {
  ...
  return (
    <Link to={`/anime/${anime.mal_id}`} className="block bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex flex-col h-full border border-slate-200">
